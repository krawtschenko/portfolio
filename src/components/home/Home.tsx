				...
				<div className={`${style.container} ${reusable.container}`}>
					...
					<div className={style.imgWrapper}>
					 ...
					 <span className={style.text_lg}>
						...
						<img src={shapeOne} alt="shape1" className={`shape ${style.shapeOne}`}/>
						<img src={shapeTwo} alt="shape2" className={`shape ${style.shapeTwo}`}/>
						<img src={shapeTwo} alt="shape2" className={`shape ${style.shapeThree}`}/>
					</div>
